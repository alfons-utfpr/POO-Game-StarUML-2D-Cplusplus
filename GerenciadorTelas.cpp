...
namespace exercicio {
    ...
    bool GerenciadorTelas::processarCodigo(int codigoRetorno) {
        ...
        {
            SegundaFase* fase = new SegundaFase(gerenciadorGrafico, jogador1);
            fase->inicializar();
            push(fase);
            return false;
        }
        ...
        {
            FaseFinal* fase = new FaseFinal(gerenciadorGrafico, jogador1);
            fase->inicializar();
            push(fase);
            return false;
        }
        ...
        case configuracoes:
            push(new MenuConfiguracoes(gerenciadorGrafico));
            return false;
