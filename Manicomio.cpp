...
namespace Jogo {
    namespace Fase {
        Manicomio::Manicomio(Gerenciador::GerenciadorGrafico& gg, Entidades::Desenhaveis::Heroi* jogador1, Entidades::Desenhaveis::Frida* jogador2) : Fase{ gg,
